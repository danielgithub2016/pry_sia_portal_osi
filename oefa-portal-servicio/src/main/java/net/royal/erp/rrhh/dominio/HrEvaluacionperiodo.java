...
*/
public class HrEvaluacionperiodo extends DominioGenerico implements java.io.Serializable{

	private HrEvaluacionperiodoPk pk;
	...
	public HrEvaluacionperiodo() {
		pk = new HrEvaluacionperiodoPk();
	}

	public HrEvaluacionperiodoPk getPk() {
		return pk;
	}

	public void setPk(HrEvaluacionperiodoPk pk) {
		this.pk = pk;
	}
