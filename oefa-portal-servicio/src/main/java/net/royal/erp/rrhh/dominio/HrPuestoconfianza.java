...
*/
public class HrPuestoconfianza extends DominioGenerico implements java.io.Serializable{

	private HrPuestoconfianzaPk pk;
	...
	public HrPuestoconfianza() {
		pk = new HrPuestoconfianzaPk();
	}

	public HrPuestoconfianzaPk getPk() {
		return pk;
	}

	public void setPk(HrPuestoconfianzaPk pk) {
		this.pk = pk;
	}
