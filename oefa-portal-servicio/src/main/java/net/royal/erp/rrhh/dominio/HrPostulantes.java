...
public class HrPostulantes extends DominioGenerico implements java.io.Serializable {

	private HrPostulantesPk pk;
	...
	public HrPostulantes() {
		pk = new HrPostulantesPk();
	}

	public HrPostulantes(String documento) {
		this.documento = documento;
	}

	public HrPostulantesPk getPk() {
		return pk;
	}

	public void setPk(HrPostulantesPk pk) {
		this.pk = pk;
	}
	...
	public void setApellidopaterno(String apellidopaterno) {
		this.apellidopaterno = UString.upper(apellidopaterno);
	}
	...
	public void setApellidomaterno(String apellidomaterno) {
		this.apellidomaterno = UString.upper(apellidomaterno);
	}
	...
	public void setNombres(String nombres) {
		this.nombres = UString.upper(nombres);
	}
	...
	public void setDireccion(String direccion) {
		this.direccion = UString.upper(direccion);
	}
	...
	public void setImpedimentos(String impedimentos) {
		this.impedimentos = UString.upper(impedimentos);
	}
	...
	public void setActbeneficas(String actbeneficas) {
		this.actbeneficas = UString.upper(actbeneficas);
	}
	...
	public void setActculturales(String actculturales) {
		this.actculturales = UString.upper(actculturales);
	}
	...
	public void setActreligiosas(String actreligiosas) {
		this.actreligiosas = UString.upper(actreligiosas);
	}
	...
	public void setActlaborales(String actlaborales) {
		this.actlaborales = UString.upper(actlaborales);
	}
	...
	public void setActdeportivas(String actdeportivas) {
		this.actdeportivas = UString.upper(actdeportivas);
	}
	...
	public void setActsociales(String actsociales) {
		this.actsociales = UString.upper(actsociales);
	}
	...
	public void setInformacionadicional(String informacionadicional) {
		this.informacionadicional = UString.upper(informacionadicional);
	}
	...
	public void setReferencia(String referencia) {
		this.referencia = UString.upper(referencia);
	}
	...
	public void setNombredependiente(String nombredependiente) {
		this.nombredependiente = UString.upper(nombredependiente);
	}
	...
	public void setParentescodependiente(String parentescodependiente) {
		this.parentescodependiente = UString.upper(parentescodependiente);
	}
	...
	public void setOficinadependiente(String oficinadependiente) {
		this.oficinadependiente = UString.upper(oficinadependiente);
	}
	...
	public String getNombrecompleto() {
		...
		if (this.apellidopaterno != null)
			retorno = retorno.trim() + " " + this.apellidopaterno.trim();
		if (this.apellidomaterno != null)
			retorno = retorno.trim() + " " + this.apellidomaterno.trim();
		nombrecompleto = retorno.trim();
	...
	public String getImagenBase64() {
		if (!UValidador.esNulo(foto)) {
			imagenBase64 = Base64.encodeBytes(foto);
		}
		return imagenBase64;
	}
	...
	public Boolean getAuxerrorreniec() {
		if (UValidador.esNulo(auxerrorreniec)) {
			auxerrorreniec = false;
		}
