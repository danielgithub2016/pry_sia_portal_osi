...
@Repository
public class HrPuestorelacionesDaoImpl extends GenericoDaoImpl<HrPuestorelaciones, HrPuestorelacionesPk> implements HrPuestorelacionesDao {

	private static Log LOGGER = LogFactory.getLog(HrPuestorelaciones.class);

	public HrPuestorelacionesDaoImpl() {
		super("hrpuestorelaciones");
	}
	...
	public List<HrPuestorelaciones> listarTabPuestoRelacion(Integer codigopuesto) {
		...
		List<HrPuestorelaciones> datos = this.listarPorCriterios(cri);
