...
@Repository
public class ResponsiblemstDaoImpl extends
		GenericoDaoImpl<Responsiblemst, ResponsiblemstPk> implements
		ResponsiblemstDao {

	private static Log LOGGER = LogFactory.getLog(Responsiblemst.class);

	public ResponsiblemstDaoImpl() {
