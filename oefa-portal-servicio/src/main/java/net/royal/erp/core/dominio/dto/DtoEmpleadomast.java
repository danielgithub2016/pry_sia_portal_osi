...
public class DtoEmpleadomast implements java.io.Serializable {
	...
	private BigDecimal codigounidad;
	...
	private String area;
	private BigDecimal codigoposicion;

	private BigDecimal horasArea;
	private BigDecimal horasGeneral;
	private BigDecimal horasConsumidas;
	private String horasConsumidasTexto;
	private BigDecimal horasSolicitadas;
	private String horasSolicitadasTexto;
	...
	public BigDecimal getCodigoposicion() {
		return codigoposicion;
	}

	public void setCodigoposicion(BigDecimal codigoposicion) {
	...
	public BigDecimal getCodigounidad() {
		return codigounidad;
	}

	public void setCodigounidad(BigDecimal codigounidad) {
	...
	public BigDecimal getHorasArea() {
		if (UValidador.esNulo(horasArea)) {
			horasArea = BigDecimal.ZERO;
		}
		return horasArea.setScale(2, RoundingMode.HALF_UP);
	}

	public void setHorasArea(BigDecimal horasArea) {
		this.horasArea = horasArea;
	}

	public BigDecimal getHorasGeneral() {
		if (UValidador.esNulo(horasGeneral)) {
			horasGeneral = BigDecimal.ZERO;
		}

		return horasGeneral.setScale(2, RoundingMode.HALF_UP);
	}

	public void setHorasGeneral(BigDecimal horasGeneral) {
		this.horasGeneral = horasGeneral;
	}

	public BigDecimal getHorasConsumidas() {
		if (UValidador.esNulo(horasConsumidas)) {
			horasConsumidas = BigDecimal.ZERO;
		}
		return horasConsumidas.setScale(2, RoundingMode.HALF_UP);
	}
	...
	public BigDecimal getHorasSolicitadas() {
		if (UValidador.esNulo(horasSolicitadas)) {
			horasSolicitadas = BigDecimal.ZERO;
		}
		return horasSolicitadas.setScale(2, RoundingMode.HALF_UP);
	}
	...
	public String getHorasConsumidasTexto() {
		return horasConsumidasTexto;
	}

	public void setHorasConsumidasTexto(String horasConsumidasTexto) {
		this.horasConsumidasTexto = horasConsumidasTexto;
	}

	public String getHorasSolicitadasTexto() {
		return horasSolicitadasTexto;
	}

	public void setHorasSolicitadasTexto(String horasSolicitadasTexto) {
		this.horasSolicitadasTexto = horasSolicitadasTexto;
	}
