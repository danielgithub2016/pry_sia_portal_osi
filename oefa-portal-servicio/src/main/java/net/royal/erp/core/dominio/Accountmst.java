...
*/
public class Accountmst extends DominioGenerico implements java.io.Serializable{

	private AccountmstPk pk;
	...
	public AccountmstPk getPk() {
		return pk;
	}

	public void setPk(AccountmstPk pk) {
		this.pk = pk;
	}
