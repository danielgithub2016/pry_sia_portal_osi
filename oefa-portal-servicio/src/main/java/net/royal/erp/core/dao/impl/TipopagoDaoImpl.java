...
@Repository
public class TipopagoDaoImpl extends GenericoDaoImpl<Tipopago, TipopagoPk>
		implements TipopagoDao {

	private static Log LOGGER = LogFactory.getLog(Tipopago.class);
	...
	public List listarTipoPago(){
		...
		cri.addOrder(Order.asc("pk.tipopago"));
