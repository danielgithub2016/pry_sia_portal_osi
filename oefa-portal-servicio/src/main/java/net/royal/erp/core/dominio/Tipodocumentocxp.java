...
*/
public class Tipodocumentocxp extends DominioGenerico implements java.io.Serializable{

	private TipodocumentocxpPk pk;
	...
	private String aplicanoafectoflag;
	private String fiscalgrupo;
	private String plancontable;


	public Tipodocumentocxp() {
		pk = new TipodocumentocxpPk();
	}

	public TipodocumentocxpPk getPk() {
		return pk;
	}

	public void setPk(TipodocumentocxpPk pk) {
		this.pk = pk;
	}
	...
	public String getAplicanoafectoflag() {
		return aplicanoafectoflag;
	}

	public void setAplicanoafectoflag(String aplicanoafectoflag) {
		this.aplicanoafectoflag = aplicanoafectoflag;
	}
	public String getFiscalgrupo() {
		return fiscalgrupo;
	}

	public void setFiscalgrupo(String fiscalgrupo) {
		this.fiscalgrupo = fiscalgrupo;
	}
