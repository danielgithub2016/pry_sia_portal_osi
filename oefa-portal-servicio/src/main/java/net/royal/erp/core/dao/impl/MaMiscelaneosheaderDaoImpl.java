...
@Repository
public class MaMiscelaneosheaderDaoImpl extends GenericoDaoImpl<MaMiscelaneosheader, MaMiscelaneosheaderPk> implements MaMiscelaneosheaderDao {

	private static Log LOGGER = LogFactory.getLog(MaMiscelaneosheader.class);
