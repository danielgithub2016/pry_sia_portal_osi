 ...
 *
 * @author desarrollo
 * @powerbuilder asmain.dw_as_proceso_asistencia_diaria_tipodia
 */
public class DtoDwAsProcesoAsistenciaDiariaTipodia implements
	...
	/**
	 * @param tiemporestringido the tiemporestringido to set
	 */
