...
public class AsArea extends DominioGenerico implements java.io.Serializable {
	...
	private String flgmarcacionpresencial;
	...
	public String getFlagcorreoresponsable1() {
		if (UValidador.estaVacio(flagcorreoresponsable1)) {
			flagcorreoresponsable1 = "";
		}
	...
	public String getFlagcorreoresponsable2() {
		if (UValidador.estaVacio(flagcorreoresponsable2)) {
			flagcorreoresponsable2 = "";
		}
	...
	public String getFlagcorreoresponsable3() {
		if (UValidador.estaVacio(flagcorreoresponsable3)) {
			flagcorreoresponsable3 = "";
		}
	...
	public String getFlagcorreoresponsable4() {
		if (UValidador.estaVacio(flagcorreoresponsable4)) {
			flagcorreoresponsable4 = "";
		}
	...
	public String getFlgmarcacionpresencial() {
		return flgmarcacionpresencial;
	}

	public void setFlgmarcacionpresencial(String flgmarcacionpresencial) {
		this.flgmarcacionpresencial = flgmarcacionpresencial;
	}
