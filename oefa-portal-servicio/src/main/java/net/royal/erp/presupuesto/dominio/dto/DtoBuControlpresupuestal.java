...
*/
public class DtoBuControlpresupuestal implements java.io.Serializable{
	...
	private Integer montototaldolares;
	...
	public Integer getMontototaldolares() {
		return montototaldolares;
	}

	public void setMontototaldolares(Integer montototaldolares) {
