 ...
 *
 * @author desarrollo
 * @powerbuilder presupuesto.BuTipopresupuesto
*/
public class BuTipopresupuesto extends DominioGenerico implements java.io.Serializable{

	private BuTipopresupuestoPk pk;
	...
	private Integer cuentacontabledigits;


	public BuTipopresupuesto() {
		pk = new BuTipopresupuestoPk();
	}

	public BuTipopresupuestoPk getPk() {
		return pk;
	}

	public void setPk(BuTipopresupuestoPk pk) {
		this.pk = pk;
	}
	...
	public Integer getCuentacontabledigits() {
		return cuentacontabledigits;
	}

	public void setCuentacontabledigits(Integer cuentacontabledigits) {
