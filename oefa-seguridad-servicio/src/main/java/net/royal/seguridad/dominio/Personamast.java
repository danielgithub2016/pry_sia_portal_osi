...
public class Personamast extends DominioGenerico implements java.io.Serializable{
	...
	private Boolean esClienteBoolean;
	private Boolean esProveedorBoolean;
	private Boolean esEmpleadoBoolean;
	private Boolean esOtroBoolean;
	...
	public Boolean getEsClienteBoolean() {
		return esClienteBoolean;
	}

	public void setEsClienteBoolean(Boolean esClienteBoolean) {
		this.esClienteBoolean = esClienteBoolean;
	}

	public Boolean getEsProveedorBoolean() {
		return esProveedorBoolean;
	}

	public void setEsProveedorBoolean(Boolean esProveedorBoolean) {
		this.esProveedorBoolean = esProveedorBoolean;
	}

	public Boolean getEsEmpleadoBoolean() {
		return esEmpleadoBoolean;
	}

	public void setEsEmpleadoBoolean(Boolean esEmpleadoBoolean) {
		this.esEmpleadoBoolean = esEmpleadoBoolean;
	}

	public Boolean getEsOtroBoolean() {
		return esOtroBoolean;
	}

	public void setEsOtroBoolean(Boolean esOtroBoolean) {
		this.esOtroBoolean = esOtroBoolean;
	}
