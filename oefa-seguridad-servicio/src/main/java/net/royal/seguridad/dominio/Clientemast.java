 ...
 *
 * @author desarrollo
 * @powerbuilder core.Clientemast
*/
public class Clientemast extends DominioGenerico implements java.io.Serializable{

	private ClientemastPk pk;
	...
	private java.util.Date licenciafechadesde;
	private java.util.Date licenciafechahasta;
	...
	private java.util.Date lineacreditofechavencimiento;
	...
	public Clientemast() {
		pk = new ClientemastPk();
	}

	public ClientemastPk getPk() {
		return pk;
	}

	public void setPk(ClientemastPk pk) {
		this.pk = pk;
	}
	...
	public java.util.Date getLicenciafechadesde() {
		return licenciafechadesde;
	}

	public void setLicenciafechadesde(java.util.Date licenciafechadesde) {
		this.licenciafechadesde = licenciafechadesde;
	}
	public java.util.Date getLicenciafechahasta() {
		return licenciafechahasta;
	}

	public void setLicenciafechahasta(java.util.Date licenciafechahasta) {
		this.licenciafechahasta = licenciafechahasta;
	}
	public String getPracticotmcflag() {
		return practicotmcflag;
	}
	...
	public java.util.Date getLineacreditofechavencimiento() {
		return lineacreditofechavencimiento;
	}

	public void setLineacreditofechavencimiento(java.util.Date lineacreditofechavencimiento) {
		this.lineacreditofechavencimiento = lineacreditofechavencimiento;
	}
	public String getGarantedireccion() {
		return garantedireccion;
	}
