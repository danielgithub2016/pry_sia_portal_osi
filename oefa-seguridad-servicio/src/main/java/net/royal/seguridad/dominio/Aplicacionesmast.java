...
*/
public class Aplicacionesmast extends DominioGenerico implements java.io.Serializable{

	private AplicacionesmastPk pk;
	...
	public Aplicacionesmast() {
		pk = new AplicacionesmastPk();
	}

	public AplicacionesmastPk getPk() {
		return pk;
	}

	public void setPk(AplicacionesmastPk pk) {
		this.pk = pk;
	}
