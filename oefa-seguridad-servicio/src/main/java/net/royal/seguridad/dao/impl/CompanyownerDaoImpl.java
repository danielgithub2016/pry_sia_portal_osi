...
@Repository("companyownerDaoImplSeguridad")
public class CompanyownerDaoImpl extends GenericoDaoImpl<Companyowner, CompanyownerPk> implements CompanyownerDao {

	private static Log LOGGER = LogFactory.getLog(Companyowner.class);

	public CompanyownerDaoImpl() {
		super("seguridad.companyowner");
	}
