...
public class PHrCapacitacionDocumentoPendiente extends LazyDataModel<HrCapacitacion> implements Serializable {
	/**
	 * 
	 */
	...
	public PHrCapacitacionDocumentoPendiente(List<ParametroPersistenciaGenerico> parametros) {
	...
	public List<HrCapacitacion> load(int registroInicio, int registrosPorPagina, String campoOrden, SortOrder sortOrder,
		...
		paginacion = CComunGlobal.getInstance().getFacRrhh().getHrCapacitacionServicio()
				.listarCapacitacionDocumentoPendiente(paginacion);
