...
public class CConsultaRenta5taCategoria extends CBaseBean implements UIMantenimientoController {
	...
	public CConsultaRenta5taCategoria() {
		this.PANTALLA_LISTADO = "ConsultaRenta5taCategoria";
	}
	...
	public String buscar() throws Exception {
		...
		if (planilla != null && periodo != null) {
			...
			File archivo = new File(pathPrincipal + 
					"/erp/planilla/recursos/reportes/renta-5ta-categoria/Renta5taCategoria.jasper");
