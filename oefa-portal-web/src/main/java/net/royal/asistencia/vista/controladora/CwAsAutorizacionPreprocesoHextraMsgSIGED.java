...
@ManagedBean
@SessionScoped
public class CwAsAutorizacionPreprocesoHextraMsgSIGED extends CBaseBean implements
	...
	public String iniciarControladora() throws Exception {
		...
		getWebControlContext().actualizar("dgIntervalosAutorizacionSIGED");
		getWebControlContext().ejecutar(
				"PF('popIntervalosAutorizacionSIGED').show()");
	...
	public static CwAsAutorizacionPreprocesoHextraMsgSIGED getInstance() {
		return UFaces.evaluateExpressionGet(
				"#{cwAsAutorizacionPreprocesoHextraMsgSIGED}",
				CwAsAutorizacionPreprocesoHextraMsgSIGED.class);
	}
